...
At this stage, we first conducted usual checks for consistency, missing values and freshness of the imported data file thay we produced at the previous [Preprocessing Step 1: Data Import & Consolidation](champions-tefas-data-import.html). Then, removed obsolete rows from the data set. 
...
All data & RDS files can be accessed from this link:
